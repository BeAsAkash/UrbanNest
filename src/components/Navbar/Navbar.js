        ...
        <div style={{}} className='container'>
            <nav style={{ borderTopLeftRadius: "10px", borderTopRightRadius: "10px", boxShadow: "0px 4px 20px 10px #0000001a" }} class="navbar navbar-expand-lg bg-body-tertiary bg-primary">
                <div class="container-fluid">
                    <Link to={"/"}><img style={{ width: "65px", height: "65px" }} className="icon" alt="Icon" src={urban}/></Link>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul style={{ display: "flex", width: "100%", justifyContent: "space-between" }} class="navbar-nav">
                            ...
                            <Link style={{ textDecoration: "none", }} to="/agents"><li class="nav-item">
                                <a style={{ color: "rgba(26, 54, 62, 1)", fontSize: "24px", fontWeight: 400, lineHeight: "28.8px" }} class="nav-link" href="#">FIND AGENT</a>
                            </li></Link>
